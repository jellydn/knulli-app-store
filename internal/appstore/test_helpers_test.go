...
func installablePackage() manifest.Package {
	return manifest.Package{
		...
		Compatibility: &manifest.Compatibility{Firmware: "knulli", MinimumVersion: "2026.05", Architectures: []string{"aarch64"}, ABIs: []string{"linux-aarch64-glibc"}, Dependencies: []string{"sdl2"}, Devices: []string{"trimui-smart-pro"}, Resolutions: []string{"1280x720"}},
